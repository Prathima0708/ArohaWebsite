            ...
            <Row className="p-5">
                ...
                <Container>
                    <Col>
                        ...
                        <Row><a href="mailto:contact@arohagroup.com" className={classes.mailTextColor}>contact@arohagroup.com</a></Row>
                    </Col>
                </Container>
                </Col>
                <Col>
                    <Container>
                        <Col>
                            <Row><h5 className={classes.textHeadingStyle}>Dubai Office</h5></Row>
                ...
                <Col>
                    <Container>
                        <Col>
                            <Row><h5 className={classes.textHeadingStyle}>Connect</h5></Row>
                            <Container className={classes.contactStyle}>
                                <Row>
                                    <Col className="mr-5 mt-4">
